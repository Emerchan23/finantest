...
console.log('=== LIMPEZA E SIMPLIFICAÇÃO PARA EMPRESA ÚNICA ===');
...
try {
    ...
    db.exec(`
        DROP TABLE IF EXISTS produtos_new;
        DROP TABLE IF EXISTS vendas_new;
        DROP TABLE IF EXISTS orcamentos_new;
        DROP TABLE IF EXISTS clientes_new;
    `);
    console.log('✅ Tabelas temporárias removidas');
    ...
    if (!foundEmpresaColumns) {
        console.log('✅ Nenhuma coluna relacionada a empresa encontrada!');
    }
